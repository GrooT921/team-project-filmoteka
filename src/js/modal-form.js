...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  const refs = {
    ...
    const openModal = () =>{
      document.getElementById('modal_form').closest('.modal_overlay').classList.add('active');
    }
    ...
    const closeModal = (e = false) =>{
      ...
      document.getElementById('modal_form').closest('.modal_overlay').classList.remove('active');
    }
    ...
    const modalForm = (e) => {
      ...
      .then(({
        ...
        <div class="form__film-img">
            <img class="form-img" src="https://image.tmdb.org/t/p/w300${poster_path}" alt="${title}" >
        </div>
        </div>
