 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{operationForChild(e){return Jt(this.path)?new sr(this.source,$t()):new sr(this.source,Vt(this.path))}constructor(e,t){this.source=e,this.path=t,this.type=tr.LISTEN_COMPLETE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class or{operationForChild(e){return Jt(this.path)?new or(this.source,$t(),this.snap.getImmediateChild(e)):new or(this.source,Vt(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=tr.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ar{operationForChild(e){if(Jt(this.path)){const t=this.children.subtree(new Wt(e));return t.isEmpty()?null:t.value?new or(this.source,$t(),t.value):new ar(this.source,$t(),t)}return m(Ht(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ar(this.source,Vt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=tr.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _r;class mr{static fromObject(e){let t=new mr(null);return _t(e,((e,n)=>{t=t.set(new Wt(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:$t(),value:this.value};if(Jt(e))return null;{const n=Ht(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(Vt(e),t);if(null!=i){return{path:Qt(new Wt(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Jt(e))return this;{const t=Ht(e),n=this.children.get(t);return null!==n?n.subtree(Vt(e)):new mr(null)}}set(e,t){if(Jt(e))return new mr(t,this.children);{const n=Ht(e),r=(this.children.get(n)||new mr(null)).set(Vt(e),t),i=this.children.insert(n,r);return new mr(this.value,i)}}remove(e){if(Jt(e))return this.children.isEmpty()?new mr(null):new mr(null,this.children);{const t=Ht(e),n=this.children.get(t);if(n){const r=n.remove(Vt(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new mr(null):new mr(this.value,i)}return this}}get(e){if(Jt(e))return this.value;{const t=Ht(e),n=this.children.get(t);return n?n.get(Vt(e)):null}}setTree(e,t){if(Jt(e))return t;{const n=Ht(e),r=(this.children.get(n)||new mr(null)).setTree(Vt(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new mr(this.value,i)}}fold(e){return this.fold_($t(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(Qt(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,$t(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if(Jt(e))return null;{const r=Ht(e),i=this.children.get(r);return i?i.findOnPath_(Vt(e),Qt(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,$t(),t)}foreachOnPath_(e,t,n){if(Jt(e))return this;{this.value&&n(t,this.value);const r=Ht(e),i=this.children.get(r);return i?i.foreachOnPath_(Vt(e),Qt(t,r),n):new mr(null)}}foreach(e){this.foreach_($t(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(Qt(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(_r||(_r=new pn(dt)),_r))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vr(e,t,n,r,i){const s=new $r;let o,a;if(n.type===tr.OVERWRITE){const c=n;c.source.fromUser?o=Kr(e,t,c.path,c.snap,r,i,s):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Jt(c.path),o=Gr(e,t,c.path,c.snap,r,i,a,s))}else if(n.type===tr.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,c)=>{const l=Qt(n,r);Qr(t,Ht(l))&&(a=Kr(e,a,l,c,i,s,o))})),r.foreach(((r,c)=>{const l=Qt(n,r);Qr(t,Ht(l))||(a=Kr(e,a,l,c,i,s,o))})),a}(e,t,c.path,c.children,r,i,s):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Xr(e,t,c.path,c.children,r,i,a,s))}else if(n.type===tr.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=Fr(r,n))return t;{const a=new zr(r,t,i),c=t.eventCache.getNode();let l;if(Jt(n)||".priority"===Ht(n)){let n;if(t.serverCache.isFullyInitialized())n=Lr(r,gr(t));else{const e=t.serverCache.getNode();m(e instanceof An,"serverChildren would be complete if leaf node"),n=Mr(r,e)}l=e.filter.updateFullNode(c,n,s)}else{const i=Ht(n);let h=qr(r,i,t.serverCache);null==h&&t.serverCache.isCompleteForChild(i)&&(h=c.getImmediateChild(i)),l=null!=h?e.filter.updateChild(c,i,h,Vt(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(c,i,An.EMPTY_NODE,Vt(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Lr(r,gr(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=Fr(r,$t()),dr(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
