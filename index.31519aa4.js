 ...
 * limitations under the License.
 */
function H(e){const t=[];for(const[n,r]of Object.entries(e))Array.isArray(r)?r.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(r));return t.length?"&"+t.join("&"):""}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var He;He="",ke(new Q("platform-logger",(e=>new Ie(e)),"PRIVATE")),ke(new Q("heartbeat",(e=>new qe(e)),"PRIVATE")),Le("@firebase/app","0.7.32",He),Le("@firebase/app","0.7.32","esm2017"),Le("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
class Ln extends cn{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),i=n.compareTo(r);return 0===i?ut(e.name,t.name):i}makePost(e,t){const n=Dn(e),r=An.EMPTY_NODE.updateChild(this.indexPath_,n);return new an(t,r)}maxPost(){const e=An.EMPTY_NODE.updateChild(this.indexPath_,On);return new an("[MAX_NAME]",e)}toString(){return Gt(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,m(!Jt(e)&&".priority"!==Ht(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{Xn(r,new $t(t.toString()+"/"+e),n)}))}class Zn{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&_t(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(nr=tr||(tr={}))[nr.OVERWRITE=0]="OVERWRITE",nr[nr.MERGE=1]="MERGE",nr[nr.ACK_USER_WRITE=2]="ACK_USER_WRITE",nr[nr.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class ir{operationForChild(e){if(Jt(this.path)){if(null!=this.affectedTree.value)return m(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new $t(e));return new ir(Wt(),t,this.revert)}}return m(Ht(this.path)===e,"operationForChild called for unrelated child."),new ir(Vt(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=tr.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{operationForChild(e){return Jt(this.path)?new sr(this.source,Wt()):new sr(this.source,Vt(this.path))}constructor(e,t){this.source=e,this.path=t,this.type=tr.LISTEN_COMPLETE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class or{operationForChild(e){return Jt(this.path)?new or(this.source,Wt(),this.snap.getImmediateChild(e)):new or(this.source,Vt(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=tr.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ar{operationForChild(e){if(Jt(this.path)){const t=this.children.subtree(new $t(e));return t.isEmpty()?null:t.value?new or(this.source,Wt(),t.value):new ar(this.source,Wt(),t)}return m(Ht(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ar(this.source,Vt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=tr.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _r;class mr{static fromObject(e){let t=new mr(null);return _t(e,((e,n)=>{t=t.set(new $t(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:Wt(),value:this.value};if(Jt(e))return null;{const n=Ht(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(Vt(e),t);if(null!=i){return{path:Qt(new $t(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Jt(e))return this;{const t=Ht(e),n=this.children.get(t);return null!==n?n.subtree(Vt(e)):new mr(null)}}set(e,t){if(Jt(e))return new mr(t,this.children);{const n=Ht(e),r=(this.children.get(n)||new mr(null)).set(Vt(e),t),i=this.children.insert(n,r);return new mr(this.value,i)}}remove(e){if(Jt(e))return this.children.isEmpty()?new mr(null):new mr(null,this.children);{const t=Ht(e),n=this.children.get(t);if(n){const r=n.remove(Vt(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new mr(null):new mr(this.value,i)}return this}}get(e){if(Jt(e))return this.value;{const t=Ht(e),n=this.children.get(t);return n?n.get(Vt(e)):null}}setTree(e,t){if(Jt(e))return t;{const n=Ht(e),r=(this.children.get(n)||new mr(null)).setTree(Vt(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new mr(this.value,i)}}fold(e){return this.fold_(Wt(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(Qt(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,Wt(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if(Jt(e))return null;{const r=Ht(e),i=this.children.get(r);return i?i.findOnPath_(Vt(e),Qt(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Wt(),t)}foreachOnPath_(e,t,n){if(Jt(e))return this;{this.value&&n(t,this.value);const r=Ht(e),i=this.children.get(r);return i?i.foreachOnPath_(Vt(e),Qt(t,r),n):new mr(null)}}foreach(e){this.foreach_(Wt(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(Qt(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(_r||(_r=new pn(dt)),_r))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vr(e,t,n,r,i){const s=new Wr;let o,a;if(n.type===tr.OVERWRITE){const c=n;c.source.fromUser?o=Kr(e,t,c.path,c.snap,r,i,s):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Jt(c.path),o=Gr(e,t,c.path,c.snap,r,i,a,s))}else if(n.type===tr.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,c)=>{const l=Qt(n,r);Qr(t,Ht(l))&&(a=Kr(e,a,l,c,i,s,o))})),r.foreach(((r,c)=>{const l=Qt(n,r);Qr(t,Ht(l))||(a=Kr(e,a,l,c,i,s,o))})),a}(e,t,c.path,c.children,r,i,s):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Xr(e,t,c.path,c.children,r,i,a,s))}else if(n.type===tr.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=Fr(r,n))return t;{const a=new zr(r,t,i),c=t.eventCache.getNode();let l;if(Jt(n)||".priority"===Ht(n)){let n;if(t.serverCache.isFullyInitialized())n=Lr(r,gr(t));else{const e=t.serverCache.getNode();m(e instanceof An,"serverChildren would be complete if leaf node"),n=Mr(r,e)}l=e.filter.updateFullNode(c,n,s)}else{const i=Ht(n);let h=qr(r,i,t.serverCache);null==h&&t.serverCache.isCompleteForChild(i)&&(h=c.getImmediateChild(i)),l=null!=h?e.filter.updateChild(c,i,h,Vt(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(c,i,An.EMPTY_NODE,Vt(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Lr(r,gr(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=Fr(r,Wt()),dr(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class js{get key(){return Jt(this._path)?null:Yt(this._path)}get ref(){return new $s(this._repo,this._path)}get _queryIdentifier(){const e=Yn(this._queryParams),t=pt(e);return"{}"===t?"default":t}get _queryObject(){return Yn(this._queryParams)}isEqual(e){if(!((e=K(e))instanceof js))return!1;const t=this._repo===e._repo,n=Zt(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}}class $s extends js{get parent(){const e=Kt(this._path);return null===e?null:new $s(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new zn,!1)}}class Ws{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new $t(e),n=zs(this.ref,e);return new Ws(this._node.getChild(t),n,In)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Ws(n,zs(this.ref,t),In))))}hasChild(e){const t=new $t(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function Hs(e,t){return(e=K(e))._checkNotDeleted("ref"),void 0!==t?zs(e._root,t):e._root}function zs(e,t){var n,r,i,s;return null===Ht((e=K(e))._path)?(n="child",r="path",s=!1,(i=t)&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),as(n,r,i,s)):as("child","path",t,!1),new $s(e._repo,Qt(e._path,t))}function Vs(e,t){e=K(e),cs("set",e._path),ss("set",t,e._path,!1);const n=new x;return Es(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Ys(e){e=K(e);const t=new qs((()=>{})),n=new Gs(t);return function(e,t,n){const r=Si(e.serverSyncTree_,t);return null!=r?Promise.resolve(r):e.server_.get(t).then((r=>{const i=Dn(r).withIndex(t._queryParams.getIndex());let s;if(Ti(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())s=Ci(e.serverSyncTree_,t._path,i);else{const n=Ai(e.serverSyncTree_,t);s=Ii(e.serverSyncTree_,t._path,i,n)}return ds(e.eventQueue_,t._path,s),Ei(e.serverSyncTree_,t,n,null,!0),i}),(n=>(Ts(e,"get for query "+D(t)+" failed: "+n),Promise.reject(new Error(n)))))}(e._repo,e,n).then((t=>new Ws(t,new $s(e._repo,e._path),e._queryParams.getIndex())))}class Gs{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new Fs("value",this,new Ws(e.snapshotNode,new $s(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Us(this,e,t):null}matches(e){return e instanceof Gs&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}!function(e){m(!si,"__referenceConstructor has already been defined"),si=e}($s),function(e){m(!oi,"__referenceConstructor has already been defined"),oi=e}($s);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();!function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),r=n.name;if("string"!=typeof r||!r)throw Ae.create("bad-app-name",{appName:String(r)});const i=Se.get(r);if(i){if($(e,i.options)&&$(n,i.config))return i;throw Ae.create("duplicate-app",{appName:r})}const s=new X(r);for(const e of Pe.values())s.addComponent(e);const o=new Oe(e,n,s);Se.set(r,o)}({apiKey:"AIzaSyBdaR4YLCQNbvL0nBLOVIY9QfiBV8jMBN8",authDomain:"filmoteka-152c6.firebaseapp.com",databaseURL:"https://filmoteka-152c6-default-rtdb.europe-west1.firebasedatabase.app",projectId:"filmoteka-152c6",storageBucket:"filmoteka-152c6.appspot.com",messagingSenderId:"913255222211",appId:"1:913255222211:web:4a70b19211bfd9fa790b76"});const no={openModalBtn:document.querySelector("[data-auth-modal-open]"),closeModalBtn:document.querySelector("[data-auth-modal-close]"),modal:document.querySelector("[data-auth-modal]"),registerForm:document.querySelector(".register-modal"),registerBtn:document.querySelector(".register-btn"),authModal:document.querySelector(".authorization-modal"),authForm:document.getElementById("auth-form"),regForm:document.getElementById("reg-form"),backToLoginBtn:document.querySelector(".login-btn"),modalForm:document.querySelector(".authorization-form")};no.openModalBtn.addEventListener("click",(function(e){no.modal.classList.remove("hidden")})),no.closeModalBtn.addEventListener("click",(function(e){no.modal.classList.add("hidden")})),no.registerBtn.addEventListener("click",(function(){no.registerForm.classList.remove("hidden"),no.authModal.classList.add("hidden")})),no.backToLoginBtn.addEventListener("click",(function(){no.registerForm.classList.add("hidden"),no.authModal.classList.remove("hidden")})),no.authForm.addEventListener("submit",(function(e){e.preventDefault();const t=Zs(),n=document.getElementById("log-user-name"),r=document.getElementById("log-user-password");Ys(zs(Hs(t),"UsersList/"+n.value)).then((e=>{if(!e.exists())return alert("User not exist yet !");e.val().password===r.value&&(alert(`You Successfuly enter in your accaunt  ${n.value} !`),t=e.val(),sessionStorage.setItem("userData",JSON.stringify(t)),document.querySelector(".close-btn").click(),function(){const e=JSON.parse(sessionStorage.getItem("userData")).userName,t=document.getElementById("user-name-contain"),n=`\n            <button\n            type="button"\n            id="sign-out-btn"\n          >Sign Out\n          </button>\n          <span style="color: white;">Hello ,${e} !</span >\n    `;t.innerHTML=n,document.querySelector(".modal-open-btn").classList.add("hidden")}(),document.getElementById("sign-out-btn").addEventListener("click",to));var t}))})),no.regForm.addEventListener("submit",(function(e){e.preventDefault();const t=document.getElementById("reg-user-name"),n=document.getElementById("reg-user-email"),r=document.getElementById("reg-user-password");if(!eo(t.value,n.value,r.value))return alert("You filled form uncorrect");const i=Zs();Ys(zs(Hs(i),"UsersList/"+t.value)).then((e=>{e.exists()?alert("User already exist !"):Vs(Hs(i,"UsersList/"+t.value),{userName:t.value,email:n.value,password:r.value}).then(alert("User Successfuly registraited !")).then(document.getElementById("reg-form").reset()).catch(console.log)}))})),document.addEventListener("keydown",(e=>{"Escape"===e.code&&no.modal.classList.add("hidden")}));var ro=async function(e,n){try{return(await t(o).get(`https://api.themoviedb.org/3/movie/${n}?api_key=${e}`)).data}catch(e){console.error(e)}};class io{static createWithoutAuth(e,t){const n=so(t);n.push(e),localStorage.setItem(`${t}`,JSON.stringify(n))}static removeWithoutAuth(e,t){const n=oo(e,t);console.log(n);const r=so(t);r.splice(n,1),localStorage.setItem(`${t}`,JSON.stringify(r))}static renderWatchedFilms(e,t){const n=so(e),r=n.length?n.map(ao).join(""):`<p style="text-align: center;">У вас ещё нету ${t} фильмов :(</p>`;document.querySelector(".card__colection").innerHTML=r}static isFilmExistInWatched(e){return-1===oo(e,"watchedFilms")?["add","Add to watched"]:["remove","Remove from watched"]}static isFilmExistInQueue(e){return-1===oo(e,"queueFilms")?["add","Add to queue"]:["remove","Remove from queue"]}}function so(e){return JSON.parse(localStorage.getItem(`${e}`)||"[]")}function oo(e,t){return so(t).findIndex((t=>t.id===e))}function ao(e){const t=new Date(e.release_date).getFullYear(),n=e.genres.map((e=>e.name));const r=n.length>2?n.slice(0,2).join(", ")+" ...":n.join(", ");return`<li class="card__film" >\n        <div class="thumb" data-id='${e.id}'>\n          <img src="https://image.tmdb.org/t/p/w500${e.poster_path}" alt="${e.title}" onerror='this.src="https://raw.githubusercontent.com/GrooT921/team-project-filmoteka/main/src/images/no-images-found.png"'/>\n        </div>\n        <h2 class="card__title">${e.title}</h2>\n        <p class="card__text">\n          <span class="genres">${r}</span> | <span class="release">${t}</span> <span\n            class="card__vote_average">${e.vote_average.toFixed(1)}</span>\n        </p>\n      </li>`}document.addEventListener("DOMContentLoaded",(()=>{const e={openModal:document.querySelector("[data-modal-open]"),closeModal:document.querySelector("[data-modal-close]"),modal:document.querySelector("[data-modal]"),form:document.querySelector(".form"),card:document.querySelector(".list")};console.log(e.card);const t=(e=!1)=>{e&&(e.stopPropagation(),e.preventDefault()),document.getElementById("modal_form").closest(".modal_overlay").classList.remove("active")};document.addEventListener("click",(e=>{if(!e.target.closest(".card__film .thumb"))return!1;const t=e.target.closest(".thumb").dataset.id;ro("9c3613c3b537f8ef5b027465b16a3a8b",t).then((e=>{const{genres:t,title:n,vote_average:r,vote_count:i,poster_path:s,popularity:o,original_title:a,overview:c}=e,l=`\n        <form class="form">\n        <div class="form__film-card">\n        <div class="form__film-img">\n            <img class="form-img" src="https://image.tmdb.org/t/p/w500${s}" alt="${n}" >\n        </div>\n        </div>\n        <div class="form__info">\n        <h2 class="form__title">${n}</h2>\n        <ul class="form__info-list">\n            <li class="form__info-item">\n                <p class="form__info-name">Vote / Votes</p>\n                <p class="form__info-details"> <span class="film__rating">${r}</span> / ${i}</p>\n            </li>\n            <li class="form__info-item">\n                <p class="form__info-name">Popularity</p>\n                <p class="form__info-details">${o}</p>\n            </li>\n            <li class="form__info-item">\n                <p class="form__info-name">Original Title</p>\n                <p class="form__info-details details-title">${a}</p>\n            </li>\n            <li class="form__info-item">\n                <p class="form__info-name">Genre</p>\n                <p class="form__info-details">${h=t,h.map((e=>e.name)).join(", ")}</p>\n            </li>\n        </ul>\n        <div class="form__about">\n        <h3 class="form__about-name">About</h3>\n        <p class="form__about-details">${c}</p>\n        </div>\n        <div class="form__btn-list">\n            <button data-action=${io.isFilmExistInWatched(e.id)[0]} id="watched" class="form-button form-active-btn" type="button">${io.isFilmExistInWatched(e.id)[1]}</button>\n            <button data-action=${io.isFilmExistInQueue(e.id)[0]} id="queue" class="form-button" type="button">${io.isFilmExistInQueue(e.id)[1]}</button>\n        </div>\n        </div>\n        </form>\n        `;var h;document.getElementById("modal_form").innerHTML=l,document.getElementById("watched").addEventListener("click",(t=>{var n,r;r=e,"add"===(n=t).target.dataset.action?(io.createWithoutAuth(r,"watchedFilms"),n.target.textContent="Remove from watched",n.target.dataset.action="remove"):(console.log(r.id),io.removeWithoutAuth(r.id,"watchedFilms"),n.target.textContent="Add to watched",n.target.dataset.action="add")})),document.getElementById("queue").addEventListener("click",(t=>{var n,r;r=e,"add"===(n=t).target.dataset.action?(io.createWithoutAuth(r,"queueFilms"),n.target.textContent="Remove from queue",n.target.dataset.action="remove"):(console.log(r.id),io.removeWithoutAuth(r.id,"queueFilms"),n.target.textContent="Add to queue",n.target.dataset.action="add")})),document.getElementById("modal_form").closest(".modal_overlay").classList.add("active")}))})),document.getElementById("btn-close").addEventListener("click",t),document.addEventListener("click",(e=>{e.target.classList.contains("modal_overlay")&&t()})),document.addEventListener("keydown",(e=>{"Escape"===e.code&&t()}))}));const co=()=>{document.querySelector("body").classList.remove("scroll-hidden"),document.querySelector(".loader").classList.add("is-hidden")};var lo,ho=function(){const e=document.getElementById("scroll-to-top");window.onscroll=function(){document.body.scrollTop>20||document.documentElement.scrollTop>20?e.style.display="block":e.style.display="none"},e.addEventListener("click",(function(){document.body.scrollTop=0,document.documentElement.scrollTop=0}))},uo={};window,
/*!
 * TOAST UI Pagination
 * @version 3.4.1
