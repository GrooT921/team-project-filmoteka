 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=function(e){let t={},n={},i={},s="";try{const r=e.split(".");t=b(d(r[0])||""),n=b(d(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:i,signature:s}},T=function(e){const t=E(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},S=function(e){const t=E(e).claims;return"object"==typeof t&&!0===t.admin};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ie(e="[DEFAULT]"){const t=ge.get(e);if(!t)throw we.create("no-app",{appName:e});return t}function Ee(e,t,n){var i;let s=null!==(i=fe[e])&&void 0!==i?i:e;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const e=[`Unable to register library "${s}" with version "${t}":`];return r&&e.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void _e.warn(e.join(" "))}ve(new B(`${s}-version`,(()=>({library:s,version:t})),"VERSION"))}let Te=null;function Se(){return Te||(Te=le("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw we.create("idb-open",{originalErrorMessage:e.message})}))),Te}async function ke(e,t){var n;try{const n=(await Se()).transaction("firebase-heartbeat-store","readwrite"),i=n.objectStore("firebase-heartbeat-store");return await i.put(t,Ne(e)),n.done}catch(e){if(e instanceof v)_e.warn(e.message);else{const t=we.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});_e.warn(t.message)}}}function Ne(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ae;Ae="",ve(new B("platform-logger",(e=>new pe(e)),"PRIVATE")),ve(new B("heartbeat",(e=>new Pe(e)),"PRIVATE")),Ee("@firebase/app","0.7.32",Ae),Ee("@firebase/app","0.7.32","esm2017"),Ee("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ii{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;vt(e,((e,i)=>{i>0&&k(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),Et(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new ni(e);const n=1e4+2e4*Math.random();Et(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ge="9.9.4",ve(new B("database",((e,{instanceIdentifier:t})=>eo(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),Ee("@firebase/database","0.13.6",e),Ee("@firebase/database","0.13.6","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
