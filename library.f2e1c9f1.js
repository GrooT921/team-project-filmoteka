 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pn{nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/Nn,10)),this.current_=this.count-1;const n=(i=this.count,parseInt(Array(i+1).join("1"),2));var i;this.bits_=e+1&n}}const Rn=function(e,t,n,i){e.sort(t);const s=function(t,i){const r=i-t;let o,a;if(0===r)return null;if(1===r)return o=e[t],a=n?n(o):o,new mn(a,o.node,mn.BLACK,null,null);{const l=parseInt(r/2,10)+t,h=s(t,l),c=s(l+1,i);return o=e[l],a=n?n(o):o,new mn(a,o.node,mn.BLACK,h,c)}},r=function(t){let i=null,r=null,o=e.length;const a=function(t,i){const r=o-t,a=o;o-=t;const h=s(r+1,a),c=e[r],u=n?n(c):c;l(new mn(u,c.node,i,null,h))},l=function(e){i?(i.left=e,i=e):(r=e,i=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),i=Math.pow(2,t.count-(e+1));n?a(i,mn.BLACK):(a(i,mn.BLACK),a(i,mn.RED))}return r}(new Pn(e.length));return new gn(i||t,r)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,r);s.forEach((s=>{s.respondsTo(n.type)&&t.push(s.createEvent(i,e.query_))}))}))}function _i(e,t){return{eventCache:e,serverCache:t}}function fi(e,t,n,i){return _i(new ui(t,n,i),e.serverCache)}function mi(e,t,n,i){return _i(e.eventCache,new ui(t,n,i))}function gi(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function yi(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class pr{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function _r(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||nn(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function fr(e,t,n){_r(e,n),mr(e,(e=>sn(e,t)||sn(t,e)))}function mr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(gr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function gr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();rt&&lt("event: "+n.toString()),It(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();!function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw we.create("bad-app-name",{appName:String(i)});const s=me.get(i);if(s){if(x(e,s.options)&&x(n,s.config))return s;throw we.create("duplicate-app",{appName:i})}const r=new W(i);for(const e of ge.values())r.addComponent(e);const o=new be(e,n,r);me.set(i,o)}({apiKey:"AIzaSyBdaR4YLCQNbvL0nBLOVIY9QfiBV8jMBN8",authDomain:"filmoteka-152c6.firebaseapp.com",databaseURL:"https://filmoteka-152c6-default-rtdb.europe-west1.firebasedatabase.app",projectId:"filmoteka-152c6",storageBucket:"filmoteka-152c6.appspot.com",messagingSenderId:"913255222211",appId:"1:913255222211:web:4a70b19211bfd9fa790b76"});function so(e){e.preventDefault();const t=document.getElementById("reg-user-name"),n=document.getElementById("modal-email"),i=document.getElementById("modal-password");if(!io(t.value,n.value,i.value))return alert("You filled form uncorrect");const s=no();Qr(Kr(Yr(s),"UsersList/"+t.value)).then((e=>{e.exists()?alert("User already exist !"):Gr(Yr(s,"UsersList/"+t.value),{userName:t.value,email:n.value,password:i.value}).then(alert("User Successfuly registraited !")).then(document.getElementById("authorization-form").reset()).catch(console.log)}))}function ro(e){e.preventDefault();const t=no(),n=document.getElementById("reg-user-name"),i=document.getElementById("modal-password");Qr(Kr(Yr(t),"UsersList/"+n.value)).then((e=>{if(!e.exists())return alert("User not exist yet !");e.val().password===i.value&&(alert(`You Successfuly enter in your accaunt  ${n.value} !`),t=e.val(),sessionStorage.setItem("userData",JSON.stringify(t)),document.querySelector(".close-btn").click(),function(){const e=JSON.parse(sessionStorage.getItem("userData")).userName,t=document.getElementById("user-name-contain"),n=`\n            <button\n            type="button"\n            id="sign-out-btn"\n          >Sign Out\n          </button>\n          <p>Hello ,${e} !</p>\n    `;t.innerHTML=n,document.querySelector(".modal-open-btn").classList.add("hidden")}());var t}))}const oo={openModalBtn:document.querySelector("[data-auth-modal-open]"),closeModalBtn:document.querySelector("[data-auth-modal-close]"),modal:document.querySelector("[data-auth-modal]"),registerForm:document.querySelector(".register-modal"),registerBtn:document.querySelector(".register-btn"),authModal:document.querySelector(".authorization-modal"),backToLoginBtn:document.querySelector(".login-btn"),modalForm:document.querySelector(".authorization-form")};oo.openModalBtn.addEventListener("click",(function(e){oo.modal.classList.remove("hidden"),oo.modalForm.addEventListener("submit",ro)})),oo.closeModalBtn.addEventListener("click",(function(e){oo.modal.classList.add("hidden")})),oo.registerBtn.addEventListener("click",(function(){oo.registerForm.classList.remove("hidden"),oo.authModal.classList.add("hidden"),oo.modalForm.removeEventListener("submit",ro),oo.modalForm.addEventListener("submit",so)})),oo.backToLoginBtn.addEventListener("click",(function(){oo.registerForm.classList.add("hidden"),oo.authModal.classList.remove("hidden"),oo.modalForm.removeEventListener("submit",so),oo.modalForm.addEventListener("submit",ro)}));const ao={libBtnsContainer:document.querySelector(".library__btn-list")};window.addEventListener("load",(()=>{n("watched","просмотренных"),ao.libBtnsContainer.addEventListener("click",t)}));
//# sourceMappingURL=library.f2e1c9f1.js.map
