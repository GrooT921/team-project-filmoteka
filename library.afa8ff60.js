 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ae(e="[DEFAULT]"){const t=Te.get(e);if(!t)throw xe.create("no-app",{appName:e});return t}function Oe(e,t,n){var r;let i=null!==(r=Ie[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${i}" with version "${t}":`];return s&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Ee.warn(e.join(" "))}ke(new G(`${i}-version`,(()=>({library:i,version:t})),"VERSION"))}let De=null;function Le(){return De||(De=me("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw xe.create("idb-open",{originalErrorMessage:e.message})}))),De}async function Me(e,t){var n;try{const n=(await Le()).transaction("firebase-heartbeat-store","readwrite"),r=n.objectStore("firebase-heartbeat-store");return await r.put(t,Be(e)),n.done}catch(e){if(e instanceof k)Ee.warn(e.message);else{const t=xe.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});Ee.warn(t.message)}}}function Be(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fe{async triggerHeartbeat(){const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),t=Ue();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==t&&!this._heartbeatsCache.heartbeats.some((e=>e.date===t)))return this._heartbeatsCache.heartbeats.push({date:t,agent:e}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((e=>{const t=new Date(e.date).valueOf();return Date.now()-t<=2592e6})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const e=Ue(),{heartbeatsToSend:t,unsentEntries:n}=function(e,t=1024){const n=[];let r=e.slice();for(const i of e){const e=n.find((e=>e.agent===i.agent));if(e){if(e.dates.push(i.date),je(n)>t){e.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),je(n)>t){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}(this._heartbeatsCache.heartbeats),r=w(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new qe(t),this._heartbeatsCachePromise=this._storage.read().then((e=>(this._heartbeatsCache=e,e)))}}function Ue(){return(new Date).toISOString().substring(0,10)}class qe{async runIndexedDBEnvironmentCheck(){return"object"==typeof indexedDB&&new Promise(((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var e;t((null===(e=i.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}})).then((()=>!0)).catch((()=>!1))}async read(){if(await this._canUseIndexedDBPromise){return await async function(e){var t;try{return(await Le()).transaction("firebase-heartbeat-store").objectStore("firebase-heartbeat-store").get(Be(e))}catch(e){if(e instanceof k)Ee.warn(e.message);else{const n=xe.create("idb-get",{originalErrorMessage:null===(t=e)||void 0===t?void 0:t.message});Ee.warn(n.message)}}}(this.app)||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Me(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Me(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}}constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}}function je(e){return w(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ut extends Ft{static getInstance(){return new Ut}getInitialEvent(e){return _("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||S()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Sn;const Nn={};class kn{static get Default(){return _(Nn&&Cn,"ChildrenNode.ts has not been loaded"),Sn=Sn||new kn({".priority":Nn},{".priority":Cn}),Sn}get(e){const t=B(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof dn?t:null}hasIndex(e){return M(this.indexSet_,e.toString())}addIndex(e,t){_(e!==ln,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const i=t.getIterator(sn.Wrap);let s,o=i.getNext();for(;o;)r=r||e.isDefinedOn(o.node),n.push(o),o=i.getNext();s=r?Tn(n,e.getCompare()):Nn;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const l=Object.assign({},this.indexes_);return l[a]=s,new kn(l,c)}addToIndexes(e,t){const n=U(this.indexes_,((n,r)=>{const i=B(this.indexSet_,r);if(_(i,"Missing index implementation for "+r),n===Nn){if(i.isDefinedOn(e.node)){const n=[],r=t.getIterator(sn.Wrap);let s=r.getNext();for(;s;)s.name!==e.name&&n.push(s),s=r.getNext();return n.push(e),Tn(n,i.getCompare())}return Nn}{const r=t.get(e.name);let i=n;return r&&(i=i.remove(new sn(e.name,r))),i.insert(e,e.node)}}));return new kn(n,this.indexSet_)}removeFromIndexes(e,t){const n=U(this.indexes_,(n=>{if(n===Nn)return n;{const r=t.get(e.name);return r?n.remove(new sn(e.name,r)):n}}));return new kn(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Mn(e){return{type:"value",snapshotNode:e}}function Bn(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function Fn(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Un(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class qn{updateChild(e,t,n,r,i,s){_(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=e.getImmediateChild(t);return o.getChild(r).equals(n.getChild(r))&&o.isEmpty()===n.isEmpty()?e:(null!=s&&(n.isEmpty()?e.hasChild(t)?s.trackChildChange(Fn(t,o)):_(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?s.trackChildChange(Bn(t,n)):s.trackChildChange(Un(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(Cn,((e,r)=>{t.hasChild(e)||n.trackChildChange(Fn(e,r))})),t.isLeafNode()||t.forEachChild(Cn,((t,r)=>{if(e.hasChild(t)){const i=e.getImmediateChild(t);i.equals(r)||n.trackChildChange(Un(t,r,i))}else n.trackChildChange(Bn(t,r))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?xn.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}constructor(e){this.index_=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{Qn(r,new qt(t.toString()+"/"+e),n)}))}class Jn{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&pt(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{operationForChild(e){if(Kt(this.path)){const t=this.children.subtree(new qt(e));return t.isEmpty()?null:t.value?new ir(this.source,jt(),t.value):new sr(this.source,jt(),t)}return _(Wt(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new sr(this.source,Ht(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Zn.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hr(e,t,n,r,i){const s=new jr;let o,a;if(n.type===Zn.OVERWRITE){const c=n;c.source.fromUser?o=Yr(e,t,c.path,c.snap,r,i,s):(_(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered()&&!Kt(c.path),o=Vr(e,t,c.path,c.snap,r,i,a,s))}else if(n.type===Zn.MERGE){const c=n;c.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,c)=>{const l=Gt(n,r);Gr(t,Wt(l))&&(a=Yr(e,a,l,c,i,s,o))})),r.foreach(((r,c)=>{const l=Gt(n,r);Gr(t,Wt(l))||(a=Yr(e,a,l,c,i,s,o))})),a}(e,t,c.path,c.children,r,i,s):(_(c.source.fromServer,"Unknown source."),a=c.source.tagged||t.serverCache.isFiltered(),o=Qr(e,t,c.path,c.children,r,i,a,s))}else if(n.type===Zn.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=Mr(r,n))return t;{const a=new $r(r,t,i),c=t.eventCache.getNode();let l;if(Kt(n)||".priority"===Wt(n)){let n;if(t.serverCache.isFullyInitialized())n=Or(r,fr(t));else{const e=t.serverCache.getNode();_(e instanceof xn,"serverChildren would be complete if leaf node"),n=Dr(r,e)}l=e.filter.updateFullNode(c,n,s)}else{const i=Wt(n);let h=Fr(r,i,t.serverCache);null==h&&t.serverCache.isCompleteForChild(i)&&(h=c.getImmediateChild(i)),l=null!=h?e.filter.updateChild(c,i,h,Ht(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(c,i,xn.EMPTY_NODE,Ht(n),a,s):c,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=Or(r,fr(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=Mr(r,jt()),hr(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Us{get key(){return Kt(this._path)?null:zt(this._path)}get ref(){return new qs(this._repo,this._path)}get _queryIdentifier(){const e=zn(this._queryParams),t=dt(e);return"{}"===t?"default":t}get _queryObject(){return zn(this._queryParams)}isEqual(e){if(!((e=Y(e))instanceof Us))return!1;const t=this._repo===e._repo,n=Jt(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}}class qs extends Us{get parent(){const e=Yt(this._path);return null===e?null:new qs(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new $n,!1)}}class js{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new qt(e),n=$s(this.ref,e);return new js(this._node.getChild(t),n,Cn)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new js(n,$s(this.ref,t),Cn))))}hasChild(e){const t=new qt(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function Ws(e,t){return(e=Y(e))._checkNotDeleted("ref"),void 0!==t?$s(e._root,t):e._root}function $s(e,t){var n,r,i,s;return null===Wt((e=Y(e))._path)?(n="child",r="path",s=!1,(i=t)&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),ss(n,r,i,s)):ss("child","path",t,!1),new qs(e._repo,Gt(e._path,t))}function Hs(e,t){e=Y(e),os("set",e._path),rs("set",t,e._path,!1);const n=new I;return bs(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function zs(e){e=Y(e);const t=new Fs((()=>{})),n=new Vs(t);return function(e,t,n){const r=Ti(e.serverSyncTree_,t);return null!=r?Promise.resolve(r):e.server_.get(t).then((r=>{const i=An(r).withIndex(t._queryParams.getIndex());let s;if(Ei(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())s=wi(e.serverSyncTree_,t._path,i);else{const n=xi(e.serverSyncTree_,t);s=Ci(e.serverSyncTree_,t._path,i,n)}return hs(e.eventQueue_,t._path,s),bi(e.serverSyncTree_,t,n,null,!0),i}),(n=>(Es(e,"get for query "+A(t)+" failed: "+n),Promise.reject(new Error(n)))))}(e._repo,e,n).then((t=>new js(t,new qs(e._repo,e._path),e._queryParams.getIndex())))}class Vs{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new Ms("value",this,new js(e.snapshotNode,new qs(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Bs(this,e,t):null}matches(e){return e instanceof Vs&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}!function(e){_(!ri,"__referenceConstructor has already been defined"),ri=e}(qs),function(e){_(!ii,"__referenceConstructor has already been defined"),ii=e}(qs);
/**
 * @license
 * Copyright 2020 Google LLC
 *
