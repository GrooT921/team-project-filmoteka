 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I(e){return JSON.parse(e)}function S(e){return JSON.stringify(e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k=function(e){let t={},n={},r={},i="";try{const s=e.split(".");t=I(g(s[0])||""),n=I(g(s[1])||""),i=s[2],r=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:r,signature:i}},N=function(e){const t=k(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},R=function(e){const t=k(e).claims;return"object"==typeof t&&!0===t.admin};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class me{getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}constructor(e){this.container=e}}const _e=new X("@firebase/app"),ye={"@firebase/app":"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},ve=new Map,we=new Map;function be(e,t){try{e.container.addComponent(t)}catch(n){_e.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Ce(e){const t=e.name;if(we.has(t))return _e.debug(`There were multiple attempts to register component ${t}.`),!1;we.set(t,e);for(const t of ve.values())be(t,e);return!0}function Ee(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Te=new E("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(e="[DEFAULT]"){const t=ve.get(e);if(!t)throw Te.create("no-app",{appName:e});return t}function ke(e,t,n){var r;let i=null!==(r=ye[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${i}" with version "${t}":`];return s&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void _e.warn(e.join(" "))}Ce(new W(`${i}-version`,(()=>({library:i,version:t})),"VERSION"))}let Ne=null;function Re(){return Ne||(Ne=ue("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw Te.create("idb-open",{originalErrorMessage:e.message})}))),Ne}async function xe(e,t){var n;try{const n=(await Re()).transaction("firebase-heartbeat-store","readwrite"),r=n.objectStore("firebase-heartbeat-store");return await r.put(t,Pe(e)),n.done}catch(e){if(e instanceof C)_e.warn(e.message);else{const t=Te.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});_e.warn(t.message)}}}function Pe(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ae{async triggerHeartbeat(){const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),t=Le();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==t&&!this._heartbeatsCache.heartbeats.some((e=>e.date===t)))return this._heartbeatsCache.heartbeats.push({date:t,agent:e}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((e=>{const t=new Date(e.date).valueOf();return Date.now()-t<=2592e6})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const e=Le(),{heartbeatsToSend:t,unsentEntries:n}=function(e,t=1024){const n=[];let r=e.slice();for(const i of e){const e=n.find((e=>e.agent===i.agent));if(e){if(e.dates.push(i.date),De(n)>t){e.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),De(n)>t){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}(this._heartbeatsCache.heartbeats),r=p(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Oe(t),this._heartbeatsCachePromise=this._storage.read().then((e=>(this._heartbeatsCache=e,e)))}}function Le(){return(new Date).toISOString().substring(0,10)}class Oe{async runIndexedDBEnvironmentCheck(){return"object"==typeof indexedDB&&new Promise(((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var e;t((null===(e=i.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}})).then((()=>!0)).catch((()=>!1))}async read(){if(await this._canUseIndexedDBPromise){return await async function(e){var t;try{return(await Re()).transaction("firebase-heartbeat-store").objectStore("firebase-heartbeat-store").get(Pe(e))}catch(e){if(e instanceof C)_e.warn(e.message);else{const n=Te.create("idb-get",{originalErrorMessage:null===(t=e)||void 0===t?void 0:t.message});_e.warn(n.message)}}}(this.app)||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return xe(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return xe(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}}constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}}function De(e){return p(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Fe;Fe="",Ce(new W("platform-logger",(e=>new me(e)),"PRIVATE")),Ce(new W("heartbeat",(e=>new Ae(e)),"PRIVATE")),ke("@firebase/app","0.7.32",Fe),ke("@firebase/app","0.7.32","esm2017"),ke("fire-js","");var Be=s("4TNnu");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{getToken(e){return this.auth_?this.auth_.getToken(e).catch((e=>e&&"auth/token-not-initialized"===e.code?(Je("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(e))):new Promise(((t,n)=>{setTimeout((()=>{this.auth_?this.getToken(e).then(t,n):t(null)}),0)}))}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then((t=>t.addAuthTokenListener(e)))}removeTokenChangeListener(e){this.authProvider_.get().then((t=>t.removeAuthTokenListener(e)))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',tt(e)}constructor(e,t,n){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=n,this.auth_=null,this.auth_=n.getImmediate({optional:!0}),this.auth_||n.onInit((e=>this.auth_=e))}}class mt{getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}constructor(e){this.accessToken=e}}mt.OWNER="owner";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const _t=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Tt{closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&dt((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt extends At{static getInstance(){return new Lt}getInitialEvent(e){return c("online"===e,"Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}constructor(){super(["online"]),this.online_=!0,"undefined"==typeof window||void 0===window.addEventListener||w()||(window.addEventListener("online",(()=>{this.online_||(this.online_=!0,this.trigger("online",!0))}),!1),window.addEventListener("offline",(()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))}),!1))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let En;class Tn{static get EMPTY_NODE(){return En||(En=new Tn(new on(ln),null,Cn.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||En}updatePriority(e){return this.children_.isEmpty()?this:new Tn(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?En:t}}getChild(e){const t=Ft(e);return null===t?this:this.getImmediateChild(t).getChild(Mt(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(c(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new Xt(e,t);let r,i;t.isEmpty()?(r=this.children_.remove(e),i=this.indexMap_.removeFromIndexes(n,this.children_)):(r=this.children_.insert(e,t),i=this.indexMap_.addToIndexes(n,this.children_));const s=r.isEmpty()?En:this.priorityNode_;return new Tn(r,s,i)}}updateChild(e,t){const n=Ft(e);if(null===n)return t;{c(".priority"!==Ft(e)||1===Bt(e),".priority must be the last token in a path");const r=this.getImmediateChild(n).updateChild(Mt(e),t);return this.updateImmediateChild(n,r)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,r=0,i=!0;if(this.forEachChild(mn,((s,o)=>{t[s]=o.val(e),n++,i&&Tn.INTEGER_REGEXP_.test(s)?r=Math.max(r,Number(s)):i=!1})),!e&&i&&r<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+hn(this.getPriority().val())+":"),this.forEachChild(mn,((t,n)=>{const r=n.hash();""!==r&&(e+=":"+t+":"+r)})),this.lazyHash_=""===e?"":Ve(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const r=this.resolveIndex_(n);if(r){const n=r.getPredecessorKey(new Xt(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new Xt(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new Xt(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,Xt.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)<0;)n.getNext(),r=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,Xt.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)>0;)n.getNext(),r=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===In?-1:0}withIndex(e){if(e===nn||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new Tn(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===nn||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator(mn),n=t.getIterator(mn);let r=e.getNext(),i=n.getNext();for(;r&&i;){if(r.name!==i.name||!r.node.equals(i.node))return!1;r=e.getNext(),i=n.getNext()}return null===r&&null===i}return!1}return!1}}resolveIndex_(e){return e===nn?null:this.indexMap_.get(e.toString())}constructor(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&un(this.priorityNode_),this.children_.isEmpty()&&c(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}}Tn.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;const In=new class extends Tn{compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return Tn.EMPTY_NODE}isEmpty(){return!1}constructor(){super(new on(ln),Tn.EMPTY_NODE,Cn.Default)}};Object.defineProperties(Xt,{MIN:{value:new Xt("[MIN_NAME]",Tn.EMPTY_NODE)},MAX:{value:new Xt("[MAX_NAME]",In)}}),tn.__EMPTY_NODE=Tn.EMPTY_NODE,gn.__childrenNodeConstructor=Tn,cn=In,function(e){pn=e}(In);function Sn(e,t=null){if(null===e)return Tn.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),c(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new gn(e,Sn(t))}if(e instanceof Array){let n=Tn.EMPTY_NODE;return lt(e,((t,r)=>{if(x(e,t)&&"."!==t.substring(0,1)){const e=Sn(r);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(Sn(t))}{const n=[];let r=!1;if(lt(e,((e,t)=>{if("."!==e.substring(0,1)){const i=Sn(t);i.isEmpty()||(r=r||!i.getPriority().isEmpty(),n.push(new Xt(e,i)))}})),0===n.length)return Tn.EMPTY_NODE;const i=vn(n,an,(e=>e.name),ln);if(r){const e=vn(n,mn.getCompare());return new Tn(i,Sn(t),new Cn({".priority":e},{".priority":mn}))}return new Tn(i,Sn(t),Cn.Default)}}!function(e){fn=e}(Sn);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class kn extends Zt{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),i=n.compareTo(r);return 0===i?rt(e.name,t.name):i}makePost(e,t){const n=Sn(e),r=Tn.EMPTY_NODE.updateChild(this.indexPath_,n);return new Xt(t,r)}maxPost(){const e=Tn.EMPTY_NODE.updateChild(this.indexPath_,In);return new Xt("[MAX_NAME]",e)}toString(){return Ut(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,c(!$t(e)&&".priority"!==Ft(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function xn(e){return{type:"value",snapshotNode:e}}function Pn(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function An(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Ln(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class On{updateChild(e,t,n,r,i,s){c(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=e.getImmediateChild(t);return o.getChild(r).equals(n.getChild(r))&&o.isEmpty()===n.isEmpty()?e:(null!=s&&(n.isEmpty()?e.hasChild(t)?s.trackChildChange(An(t,o)):c(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?s.trackChildChange(Pn(t,n)):s.trackChildChange(Ln(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(mn,((e,r)=>{t.hasChild(e)||n.trackChildChange(An(e,r))})),t.isLeafNode()||t.forEachChild(mn,((t,r)=>{if(e.hasChild(t)){const i=e.getImmediateChild(t);i.equals(r)||n.trackChildChange(Ln(t,r,i))}else n.trackChildChange(Pn(t,r))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?Tn.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}constructor(e){this.index_=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn{getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){return this.index_.compare(this.getStartPost(),e)<=0&&this.index_.compare(e,this.getEndPost())<=0}updateChild(e,t,n,r,i,s){return this.matches(new Xt(t,n))||(n=Tn.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,n,r,i,s)}updateFullNode(e,t,n){t.isLeafNode()&&(t=Tn.EMPTY_NODE);let r=t.withIndex(this.index_);r=r.updatePriority(Tn.EMPTY_NODE);const i=this;return t.forEachChild(mn,((e,t)=>{i.matches(new Xt(e,t))||(r=r.updateImmediateChild(e,Tn.EMPTY_NODE))})),this.indexedFilter_.updateFullNode(e,r,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}return e.getIndex().maxPost()}constructor(e){this.indexedFilter_=new On(e.getIndex()),this.index_=e.getIndex(),this.startPost_=Dn.getStartPost_(e),this.endPost_=Dn.getEndPost_(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn{updateChild(e,t,n,r,i,s){return this.rangedFilter_.matches(new Xt(t,n))||(n=Tn.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,r,i,s):this.fullLimitUpdateChild_(e,t,n,i,s)}updateFullNode(e,t,n){let r;if(t.isLeafNode()||t.isEmpty())r=Tn.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){let e;r=Tn.EMPTY_NODE.withIndex(this.index_),e=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let n=0;for(;e.hasNext()&&n<this.limit_;){const t=e.getNext();let i;if(i=this.reverse_?this.index_.compare(this.rangedFilter_.getStartPost(),t)<=0:this.index_.compare(t,this.rangedFilter_.getEndPost())<=0,!i)break;r=r.updateImmediateChild(t.name,t.node),n++}}else{let e,n,i,s;if(r=t.withIndex(this.index_),r=r.updatePriority(Tn.EMPTY_NODE),this.reverse_){s=r.getReverseIterator(this.index_),e=this.rangedFilter_.getEndPost(),n=this.rangedFilter_.getStartPost();const t=this.index_.getCompare();i=(e,n)=>t(n,e)}else s=r.getIterator(this.index_),e=this.rangedFilter_.getStartPost(),n=this.rangedFilter_.getEndPost(),i=this.index_.getCompare();let o=0,a=!1;for(;s.hasNext();){const t=s.getNext();!a&&i(e,t)<=0&&(a=!0);a&&o<this.limit_&&i(t,n)<=0?o++:r=r.updateImmediateChild(t.name,Tn.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,r,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,n,r,i){let s;if(this.reverse_){const e=this.index_.getCompare();s=(t,n)=>e(n,t)}else s=this.index_.getCompare();const o=e;c(o.numChildren()===this.limit_,"");const a=new Xt(t,n),l=this.reverse_?o.getFirstChild(this.index_):o.getLastChild(this.index_),h=this.rangedFilter_.matches(a);if(o.hasChild(t)){const e=o.getImmediateChild(t);let c=r.getChildAfterChild(this.index_,l,this.reverse_);for(;null!=c&&(c.name===t||o.hasChild(c.name));)c=r.getChildAfterChild(this.index_,c,this.reverse_);const u=null==c?1:s(c,a);if(h&&!n.isEmpty()&&u>=0)return null!=i&&i.trackChildChange(Ln(t,n,e)),o.updateImmediateChild(t,n);{null!=i&&i.trackChildChange(An(t,e));const n=o.updateImmediateChild(t,Tn.EMPTY_NODE);return null!=c&&this.rangedFilter_.matches(c)?(null!=i&&i.trackChildChange(Pn(c.name,c.node)),n.updateImmediateChild(c.name,c.node)):n}}return n.isEmpty()?e:h&&s(l,a)>=0?(null!=i&&(i.trackChildChange(An(l.name,l.node)),i.trackChildChange(Pn(t,n))),o.updateImmediateChild(t,n).updateImmediateChild(l.name,Tn.EMPTY_NODE)):e}constructor(e){this.rangedFilter_=new Dn(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{hasStart(){return this.startSet_}hasStartAfter(){return this.startAfterSet_}hasEndBefore(){return this.endBeforeSet_}isViewFromLeft(){return""===this.viewFrom_?this.startSet_:"l"===this.viewFrom_}getIndexStartValue(){return c(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return c(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:"[MIN_NAME]"}hasEnd(){return this.endSet_}getIndexEndValue(){return c(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return c(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:"[MAX_NAME]"}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&""!==this.viewFrom_}getLimit(){return c(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===mn}copy(){const e=new Bn;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=mn}}function Mn(e){const t={};if(e.isDefault())return t;let n;return e.index_===mn?n="$priority":e.index_===Nn?n="$value":e.index_===nn?n="$key":(c(e.index_ instanceof kn,"Unrecognized index type!"),n=e.index_.toString()),t.orderBy=S(n),e.startSet_&&(t.startAt=S(e.indexStartValue_),e.startNameSet_&&(t.startAt+=","+S(e.indexStartName_))),e.endSet_&&(t.endAt=S(e.indexEndValue_),e.endNameSet_&&(t.endAt+=","+S(e.indexEndName_))),e.limitSet_&&(e.isViewFromLeft()?t.limitToFirst=e.limit_:t.limitToLast=e.limit_),t}function qn(e){const t={};if(e.startSet_&&(t.sp=e.indexStartValue_,e.startNameSet_&&(t.sn=e.indexStartName_)),e.endSet_&&(t.ep=e.indexEndValue_,e.endNameSet_&&(t.en=e.indexEndName_)),e.limitSet_){t.l=e.limit_;let n=e.viewFrom_;""===n&&(n=e.isViewFromLeft()?"l":"r"),t.vf=n}return e.index_!==mn&&(t.i=e.index_.toString()),t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}constructor(){this.rootNode_=Tn.EMPTY_NODE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{Hn(r,new Ot(t.toString()+"/"+e),n)}))}class zn{get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&lt(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}constructor(e){this.collection_=e,this.last_=null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Gn,Yn;function Kn(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Yn=Gn||(Gn={}))[Yn.OVERWRITE=0]="OVERWRITE",Yn[Yn.MERGE=1]="MERGE",Yn[Yn.ACK_USER_WRITE=2]="ACK_USER_WRITE",Yn[Yn.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Qn{operationForChild(e){if($t(this.path)){if(null!=this.affectedTree.value)return c(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Ot(e));return new Qn(Dt(),t,this.revert)}}return c(Ft(this.path)===e,"operationForChild called for unrelated child."),new Qn(Mt(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Gn.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jn{operationForChild(e){return $t(this.path)?new Jn(this.source,Dt()):new Jn(this.source,Mt(this.path))}constructor(e,t){this.source=e,this.path=t,this.type=Gn.LISTEN_COMPLETE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xn{operationForChild(e){return $t(this.path)?new Xn(this.source,Dt(),this.snap.getImmediateChild(e)):new Xn(this.source,Mt(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Gn.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zn{operationForChild(e){if($t(this.path)){const t=this.children.subtree(new Ot(e));return t.isEmpty()?null:t.value?new Xn(this.source,Dt(),t.value):new Zn(this.source,Dt(),t)}return c(Ft(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Zn(this.source,Mt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Gn.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let lr;class cr{static fromObject(e){let t=new cr(null);return lt(e,((e,n)=>{t=t.set(new Ot(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:Dt(),value:this.value};if($t(e))return null;{const n=Ft(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(Mt(e),t);if(null!=i){return{path:Wt(new Ot(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if($t(e))return this;{const t=Ft(e),n=this.children.get(t);return null!==n?n.subtree(Mt(e)):new cr(null)}}set(e,t){if($t(e))return new cr(t,this.children);{const n=Ft(e),r=(this.children.get(n)||new cr(null)).set(Mt(e),t),i=this.children.insert(n,r);return new cr(this.value,i)}}remove(e){if($t(e))return this.children.isEmpty()?new cr(null):new cr(null,this.children);{const t=Ft(e),n=this.children.get(t);if(n){const r=n.remove(Mt(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new cr(null):new cr(this.value,i)}return this}}get(e){if($t(e))return this.value;{const t=Ft(e),n=this.children.get(t);return n?n.get(Mt(e)):null}}setTree(e,t){if($t(e))return t;{const n=Ft(e),r=(this.children.get(n)||new cr(null)).setTree(Mt(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new cr(this.value,i)}}fold(e){return this.fold_(Dt(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(Wt(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,Dt(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if($t(e))return null;{const r=Ft(e),i=this.children.get(r);return i?i.findOnPath_(Mt(e),Wt(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Dt(),t)}foreachOnPath_(e,t,n){if($t(e))return this;{this.value&&n(t,this.value);const r=Ft(e),i=this.children.get(r);return i?i.foreachOnPath_(Mt(e),Wt(t,r),n):new cr(null)}}foreach(e){this.foreach_(Dt(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(Wt(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}constructor(e,t=(()=>(lr||(lr=new on(it)),lr))()){this.value=e,this.children=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr{static empty(){return new hr(new cr(null))}constructor(e){this.writeTree_=e}}function ur(e,t,n){if($t(t))return new hr(new cr(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){const i=r.path;let s=r.value;const o=Ht(i,t);return s=s.updateChild(o,n),new hr(e.writeTree_.set(i,s))}{const r=new cr(n),i=e.writeTree_.setTree(t,r);return new hr(i)}}}function dr(e,t,n){let r=e;return lt(n,((e,n)=>{r=ur(r,Wt(t,e),n)})),r}function fr(e,t){if($t(t))return hr.empty();{const n=e.writeTree_.setTree(t,new cr(null));return new hr(n)}}function pr(e,t){return null!=gr(e,t)}function gr(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Ht(n.path,t)):null}function mr(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(mn,((e,n)=>{t.push(new Xt(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Xt(e,n.value))})),t}function _r(e,t){if($t(t))return e;{const n=gr(e,t);return new hr(null!=n?new cr(n):e.writeTree_.subtree(t))}}function yr(e){return e.writeTree_.isEmpty()}function vr(e,t){return wr(Dt(),e.writeTree_,t)}function wr(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,i)=>{".priority"===t?(c(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=wr(Wt(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(Wt(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function br(e,t){return Or(t,e)}function Cr(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));c(n>=0,"removeWrite called with nonexistent writeId.");const r=e.allWrites[n];e.allWrites.splice(n,1);let i=r.visible,s=!1,o=e.allWrites.length-1;for(;i&&o>=0;){const t=e.allWrites[o];t.visible&&(o>=n&&Er(t,r.path)?i=!1:Vt(r.path,t.path)&&(s=!0)),o--}if(i){if(s)return function(e){e.visibleWrites=Ir(e.allWrites,Tr,Dt()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(r.snap)e.visibleWrites=fr(e.visibleWrites,r.path);else{lt(r.children,(t=>{e.visibleWrites=fr(e.visibleWrites,Wt(r.path,t))}))}return!0}return!1}function Er(e,t){if(e.snap)return Vt(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&Vt(Wt(e.path,n),t))return!0;return!1}function Tr(e){return e.visible}function Ir(e,t,n){let r=hr.empty();for(let i=0;i<e.length;++i){const s=e[i];if(t(s)){const e=s.path;let t;if(s.snap)Vt(n,e)?(t=Ht(n,e),r=ur(r,t,s.snap)):Vt(e,n)&&(t=Ht(e,n),r=ur(r,Dt(),s.snap.getChild(t)));else{if(!s.children)throw h("WriteRecord should have .snap or .children");if(Vt(n,e))t=Ht(n,e),r=dr(r,t,s.children);else if(Vt(e,n))if(t=Ht(e,n),$t(t))r=dr(r,Dt(),s.children);else{const e=P(s.children,Ft(t));if(e){const n=e.getChild(Mt(t));r=ur(r,Dt(),n)}}}}}return r}function Sr(e,t,n,r,i){if(r||i){const s=_r(e.visibleWrites,t);if(!i&&yr(s))return n;if(i||null!=n||pr(s,Dt())){const s=function(e){return(e.visible||i)&&(!r||!~r.indexOf(e.writeId))&&(Vt(e.path,t)||Vt(t,e.path))};return vr(Ir(e.allWrites,s,t),n||Tn.EMPTY_NODE)}return null}{const r=gr(e.visibleWrites,t);if(null!=r)return r;{const r=_r(e.visibleWrites,t);if(yr(r))return n;if(null!=n||pr(r,Dt())){return vr(r,n||Tn.EMPTY_NODE)}return null}}}function kr(e,t,n,r){return Sr(e.writeTree,e.treePath,t,n,r)}function Nr(e,t){return function(e,t,n){let r=Tn.EMPTY_NODE;const i=gr(e.visibleWrites,t);if(i)return i.isLeafNode()||i.forEachChild(mn,((e,t)=>{r=r.updateImmediateChild(e,t)})),r;if(n){const i=_r(e.visibleWrites,t);return n.forEachChild(mn,((e,t)=>{const n=vr(_r(i,new Ot(e)),t);r=r.updateImmediateChild(e,n)})),mr(i).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}return mr(_r(e.visibleWrites,t)).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}(e.writeTree,e.treePath,t)}function Rr(e,t,n,r){return function(e,t,n,r,i){c(r||i,"Either existingEventSnap or existingServerSnap must exist");const s=Wt(t,n);if(pr(e.visibleWrites,s))return null;{const t=_r(e.visibleWrites,s);return yr(t)?i.getChild(n):vr(t,i.getChild(n))}}(e.writeTree,e.treePath,t,n,r)}function xr(e,t){return function(e,t){return gr(e.visibleWrites,t)}(e.writeTree,Wt(e.treePath,t))}function Pr(e,t,n,r,i,s){return function(e,t,n,r,i,s,o){let a;const l=_r(e.visibleWrites,t),c=gr(l,Dt());if(null!=c)a=c;else{if(null==n)return[];a=vr(l,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=s?a.getReverseIteratorFrom(r,o):a.getIteratorFrom(r,o);let l=n.getNext();for(;l&&e.length<i;)0!==t(l,r)&&e.push(l),l=n.getNext();return e}}(e.writeTree,e.treePath,t,n,r,i,s)}function Ar(e,t,n){return function(e,t,n,r){const i=Wt(t,n),s=gr(e.visibleWrites,i);if(null!=s)return s;if(r.isCompleteForChild(n))return vr(_r(e.visibleWrites,i),r.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function Lr(e,t){return Or(Wt(e.treePath,t),e.writeTree)}function Or(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mr(e,t,n,r,i){const s=new Dr;let o,a;if(n.type===Gn.OVERWRITE){const l=n;l.source.fromUser?o=jr(e,t,l.path,l.snap,r,i,s):(c(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!$t(l.path),o=Ur(e,t,l.path,l.snap,r,i,a,s))}else if(n.type===Gn.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,r,i,s,o){let a=t;return r.foreach(((r,l)=>{const c=Wt(n,r);Wr(t,Ft(c))&&(a=jr(e,a,c,l,i,s,o))})),r.foreach(((r,l)=>{const c=Wt(n,r);Wr(t,Ft(c))||(a=jr(e,a,c,l,i,s,o))})),a}(e,t,l.path,l.children,r,i,s):(c(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Hr(e,t,l.path,l.children,r,i,a,s))}else if(n.type===Gn.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,r,i,s){let o;if(null!=xr(r,n))return t;{const a=new Br(r,t,i),l=t.eventCache.getNode();let h;if($t(n)||".priority"===Ft(n)){let n;if(t.serverCache.isFullyInitialized())n=kr(r,ar(t));else{const e=t.serverCache.getNode();c(e instanceof Tn,"serverChildren would be complete if leaf node"),n=Nr(r,e)}h=e.filter.updateFullNode(l,n,s)}else{const i=Ft(n);let c=Ar(r,i,t.serverCache);null==c&&t.serverCache.isCompleteForChild(i)&&(c=l.getImmediateChild(i)),h=null!=c?e.filter.updateChild(l,i,c,Mt(n),a,s):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(l,i,Tn.EMPTY_NODE,Mt(n),a,s):l,h.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=kr(r,ar(t)),o.isLeafNode()&&(h=e.filter.updateFullNode(h,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=xr(r,Dt()),ir(t,h,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let hi=1;class ui{constructor(e){this.listenProvider_=e,this.syncPointTree_=new cr(null),this.pendingWriteTree_={visibleWrites:hr.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function di(e,t,n,r,i){return function(e,t,n,r,i){c(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=ur(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?wi(e,new Xn({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function fi(e,t,n=!1){const r=function(e,t){for(let n=0;n<e.allWrites.length;n++){const r=e.allWrites[n];if(r.writeId===t)return r}return null}(e.pendingWriteTree_,t);if(Cr(e.pendingWriteTree_,t)){let t=new cr(null);return null!=r.snap?t=t.set(Dt(),!0):lt(r.children,(e=>{t=t.set(new Ot(e),!0)})),wi(e,new Qn(r.path,t,n))}return[]}function pi(e,t,n){return wi(e,new Xn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function gi(e,t,n,r,i=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||ai(o,t))){const l=ri(o,t,n,r);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!i){const n=-1!==c.findIndex((e=>e._queryParams.loadsAllData())),i=e.syncPointTree_.findOnPath(s,((e,t)=>li(t)));if(n&&!i){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&li(t)){return[ci(t)]}{let e=[];return t&&(e=ii(t)),lt(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const r=n[t],i=r.query,s=Ei(e,r);e.listenProvider_.startListening(Ri(i),Ti(e,i),s.hashFn,s.onComplete)}}}if(!i&&c.length>0&&!r)if(n){const n=null;e.listenProvider_.stopListening(Ri(t),n)}else c.forEach((t=>{const n=e.queryToTagMap.get(Ii(t));e.listenProvider_.stopListening(Ri(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const r=t[n];if(!r._queryParams.loadsAllData()){const t=Ii(r),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,c)}return a}function mi(e,t,n,r){const i=Si(e,r);if(null!=i){const r=ki(i),s=r.path,o=r.queryId,a=Ht(s,t);return Ni(e,s,new Xn(Kn(o),a,n))}return[]}function _i(e,t,n,r=!1){const i=t._path;let s=null,o=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Ht(e,i);s=s||si(t,n),o=o||li(t)}));let a,l=e.syncPointTree_.get(i);if(l?(o=o||li(l),s=s||si(l,Dt())):(l=new Zr,e.syncPointTree_=e.syncPointTree_.set(i,l)),null!=s)a=!0;else{a=!1,s=Tn.EMPTY_NODE;e.syncPointTree_.subtree(i).foreachChild(((e,t)=>{const n=si(t,Dt());n&&(s=s.updateImmediateChild(e,n))}))}const h=ai(l,t);if(!h&&!t._queryParams.loadsAllData()){const n=Ii(t);c(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const r=hi++;e.queryToTagMap.set(n,r),e.tagToQueryMap.set(r,n)}let u=ni(l,t,n,br(e.pendingWriteTree_,i),s,a);if(!h&&!o&&!r){const n=oi(l,t);u=u.concat(function(e,t,n){const r=t._path,i=Ti(e,t),s=Ei(e,n),o=e.listenProvider_.startListening(Ri(t),i,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(r);if(i)c(!li(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!$t(e)&&t&&li(t))return[ci(t).query];{let e=[];return t&&(e=e.concat(ii(t).map((e=>e.query)))),lt(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const r=t[n];e.listenProvider_.stopListening(Ri(r),Ti(e,r))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return u}function yi(e,t,n){const r=e.pendingWriteTree_,i=e.syncPointTree_.findOnPath(t,((e,n)=>{const r=si(n,Ht(e,t));if(r)return r}));return Sr(r,t,i,n,!0)}function vi(e,t){const n=t._path;let r=null;e.syncPointTree_.foreachOnPath(n,((e,t)=>{const i=Ht(e,n);r=r||si(t,i)}));let i=e.syncPointTree_.get(n);i?r=r||si(i,Dt()):(i=new Zr,e.syncPointTree_=e.syncPointTree_.set(n,i));const s=null!=r,o=s?new er(r,!0,!1):null;return function(e){return or(e.viewCache_)}(ti(i,t,br(e.pendingWriteTree_,t._path),s?o.getNode():Tn.EMPTY_NODE,s))}function wi(e,t){return bi(t,e.syncPointTree_,null,br(e.pendingWriteTree_,Dt()))}function bi(e,t,n,r){if($t(e.path))return Ci(e,t,n,r);{const i=t.get(Dt());null==n&&null!=i&&(n=si(i,Dt()));let s=[];const o=Ft(e.path),a=e.operationForChild(o),l=t.children.get(o);if(l&&a){const e=n?n.getImmediateChild(o):null,t=Lr(r,o);s=s.concat(bi(a,l,e,t))}return i&&(s=s.concat(ei(i,e,r,n))),s}}function Ci(e,t,n,r){const i=t.get(Dt());null==n&&null!=i&&(n=si(i,Dt()));let s=[];return t.children.inorderTraversal(((t,i)=>{const o=n?n.getImmediateChild(t):null,a=Lr(r,t),l=e.operationForChild(t);l&&(s=s.concat(Ci(l,i,o,a)))})),i&&(s=s.concat(ei(i,e,r,n))),s}function Ei(e,t){const n=t.query,r=Ti(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||Tn.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return r?function(e,t,n){const r=Si(e,n);if(r){const n=ki(r),i=n.path,s=n.queryId,o=Ht(i,t);return Ni(e,i,new Jn(Kn(s),o))}return[]}(e,n._path,r):function(e,t){return wi(e,new Jn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const r=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const r=new Error(e+" at "+t._path.toString()+": "+n);return r.code=e.toUpperCase(),r}(t,n);return gi(e,n,null,r)}}}}function Ti(e,t){const n=Ii(t);return e.queryToTagMap.get(n)}function Ii(e){return e._path.toString()+"$"+e._queryIdentifier}function Si(e,t){return e.tagToQueryMap.get(t)}function ki(e){const t=e.indexOf("$");return c(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Ot(e.substr(0,t))}}function Ni(e,t,n){const r=e.syncPointTree_.get(t);c(r,"Missing sync point for query tag that we're tracking");return ei(r,n,br(e.pendingWriteTree_,t),null)}function Ri(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(c(Xr,"Reference.ts has not been loaded"),Xr)(e._repo,e._path):e}class xi{getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new xi(t)}node(){return this.node_}constructor(e){this.node_=e}}class Pi{getImmediateChild(e){const t=Wt(this.path_,e);return new Pi(this.syncTree_,t)}node(){return yi(this.syncTree_,this.path_)}constructor(e,t){this.syncTree_=e,this.path_=t}}const Ai=function(e,t,n){return e&&"object"==typeof e?(c(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Li(e[".sv"],t,n):"object"==typeof e[".sv"]?Oi(e[".sv"],t):void c(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Li=function(e,t,n){if("timestamp"===e)return n.timestamp;c(!1,"Unexpected server value: "+e)},Oi=function(e,t,n){e.hasOwnProperty("increment")||c(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const r=e.increment;"number"!=typeof r&&c(!1,"Unexpected increment value: "+r);const i=t.node();if(c(null!=i,"Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return r;const s=i.getValue();return"number"!=typeof s?r:s+r},Di=function(e,t,n,r){return Bi(t,new Pi(n,e),r)},Fi=function(e,t,n){return Bi(e,new xi(t),n)};function Bi(e,t,n){const r=e.getPriority().val(),i=Ai(r,t.getImmediateChild(".priority"),n);let s;if(e.isLeafNode()){const r=e,s=Ai(r.getValue(),t,n);return s!==r.getValue()||i!==r.getPriority().val()?new gn(s,Sn(i)):e}{const r=e;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new gn(i))),r.forEachChild(mn,((e,r)=>{const i=Bi(r,t.getImmediateChild(e),n);i!==r&&(s=s.updateImmediateChild(e,i))})),s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ns{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function rs(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],s=i.getPath();null===n||zt(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(i)}n&&e.eventLists_.push(n)}function is(e,t,n){rs(e,n),ss(e,(e=>Vt(e,t)||Vt(t,e)))}function ss(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){t(i.path)?(os(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function os(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const r=n.getEventRunner();Ye&&Je("event: "+n.toString()),dt(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ls{get key(){return $t(this._path)?null:qt(this._path)}get ref(){return new Os(this._repo,this._path)}get _queryIdentifier(){const e=qn(this._queryParams),t=ot(e);return"{}"===t?"default":t}get _queryObject(){return qn(this._queryParams)}isEqual(e){if(!((e=j(e))instanceof Ls))return!1;const t=this._repo===e._repo,n=zt(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}}class Os extends Ls{get parent(){const e=jt(this._path);return null===e?null:new Os(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new Bn,!1)}}class Ds{get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Ot(e),n=Bs(this.ref,e);return new Ds(this._node.getChild(t),n,mn)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Ds(n,Bs(this.ref,t),mn))))}hasChild(e){const t=new Ot(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}constructor(e,t,n){this._node=e,this.ref=t,this._index=n}}function Fs(e,t){return(e=j(e))._checkNotDeleted("ref"),void 0!==t?Bs(e._root,t):e._root}function Bs(e,t){var n,r,i,s;return null===Ft((e=j(e))._path)?(n="child",r="path",s=!1,(i=t)&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),Zi(n,r,i,s)):Zi("child","path",t,!1),new Os(e._repo,Wt(e._path,t))}function Ms(e,t){e=j(e),es("set",e._path),Ji("set",t,e._path,!1);const n=new y;return gs(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function qs(e){e=j(e);const t=new As((()=>{})),n=new Us(t);return function(e,t,n){const r=vi(e.serverSyncTree_,t);return null!=r?Promise.resolve(r):e.server_.get(t).then((r=>{const i=Sn(r).withIndex(t._queryParams.getIndex());let s;if(_i(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())s=pi(e.serverSyncTree_,t._path,i);else{const n=Ti(e.serverSyncTree_,t);s=mi(e.serverSyncTree_,t._path,i,n)}return is(e.eventQueue_,t._path,s),gi(e.serverSyncTree_,t,n,null,!0),i}),(n=>(_s(e,"get for query "+S(t)+" failed: "+n),Promise.reject(new Error(n)))))}(e._repo,e,n).then((t=>new Ds(t,new Os(e._repo,e._path),e._queryParams.getIndex())))}class Us{respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new xs("value",this,new Ds(e.snapshotNode,new Os(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Ps(this,e,t):null}matches(e){return e instanceof Us&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}constructor(e){this.callbackContext=e}}!function(e){c(!Jr,"__referenceConstructor has already been defined"),Jr=e}(Os),function(e){c(!Xr,"__referenceConstructor has already been defined"),Xr=e}(Os);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const js={};let Ws=!1;function $s(e,t,n,r,i){let s=r||e.options.databaseURL;void 0===s&&(e.options.projectId||et("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Je("Using default host for project ",e.options.projectId),s=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=Ns(s,i),c=l.repoInfo;void 0!==Be&&Be.env&&(a=Be.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,s=`http://${a}?ns=${c.namespace}`,l=Ns(s,i),c=l.repoInfo):o=!l.repoInfo.secure;const h=i&&o?new mt(mt.OWNER):new gt(e.name,e.options,t);ts("Invalid Firebase Database URL",l),$t(l.path)||et("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,r){let i=js[t.name];i||(i={},js[t.name]=i);let s=i[e.toURLString()];s&&et("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return s=new as(e,Ws,n,r),i[e.toURLString()]=s,s}(c,e,h,new pt(e.name,n));return new Hs(u,e)}class Hs{get _repo(){return this._instanceStarted||(ls(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Os(this._repo,Dt())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=js[t];n&&n[e.key]===e||et(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ms(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&et("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}function zs(e=Se(),t){return Ee(e,"database").getImmediate({identifier:t})}Jt.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Jt.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Me="9.9.4",Ce(new W("database",((e,{instanceIdentifier:t})=>$s(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ke("@firebase/database","0.13.6",e),ke("@firebase/database","0.13.6","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
ke("firebase","9.9.4","app");!function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),r=n.name;if("string"!=typeof r||!r)throw Te.create("bad-app-name",{appName:String(r)});const i=ve.get(r);if(i){if(O(e,i.options)&&O(n,i.config))return i;throw Te.create("duplicate-app",{appName:r})}const s=new H(r);for(const e of we.values())s.addComponent(e);const o=new Ie(e,n,s);ve.set(r,o)}({apiKey:"AIzaSyBdaR4YLCQNbvL0nBLOVIY9QfiBV8jMBN8",authDomain:"filmoteka-152c6.firebaseapp.com",databaseURL:"https://filmoteka-152c6-default-rtdb.europe-west1.firebasedatabase.app",projectId:"filmoteka-152c6",storageBucket:"filmoteka-152c6.appspot.com",messagingSenderId:"913255222211",appId:"1:913255222211:web:4a70b19211bfd9fa790b76"});function so(){const e=`\n            <button\n            type="button"\n            class="sign__out-btn"\n            id="sign-out-btn"\n          >\n          <svg class="modal-open-btn__icon">\n            <use href="${s("1yNW2")}#exit-icon"></use> \n          </svg>\n          </button>\n          <span class="auth__text" style="color: white;">Hello, ${JSON.parse(localStorage.getItem("userData")).userName}!</span >\n    `;document.getElementById("user-name-contain").innerHTML=e,document.querySelector(".modal-open-btn").classList.add("hidden")}function oo(){document.getElementById("sign-out-btn").addEventListener("click",io)}const ao={openModalBtn:document.querySelector("[data-auth-modal-open]"),closeModalBtn:document.querySelector("[data-auth-modal-close]"),modal:document.querySelector("[data-auth-modal]"),registerForm:document.querySelector(".register-modal"),registerBtn:document.querySelector(".register-btn"),authModal:document.querySelector(".authorization-modal"),authForm:document.getElementById("auth-form"),regForm:document.getElementById("reg-form"),backToLoginBtn:document.querySelector(".login-btn"),modalForm:document.querySelector(".authorization-form")};ao.openModalBtn.addEventListener("click",(function(e){ao.modal.classList.remove("hidden"),document.body.classList.add("overflow-hidden"),document.body.style.position="fixed",document.body.style.top=`-${window.scrollY}px`})),ao.closeModalBtn.addEventListener("click",(function(e){ao.modal.classList.add("hidden");const t=document.body.style.top;document.body.style.position="",document.body.style.top="",window.scrollTo(0,-1*parseInt(t||"0"))})),ao.registerBtn.addEventListener("click",(function(){ao.registerForm.classList.remove("hidden"),ao.authModal.classList.add("hidden")})),ao.backToLoginBtn.addEventListener("click",(function(){ao.registerForm.classList.add("hidden"),ao.authModal.classList.remove("hidden")})),ao.authForm.addEventListener("submit",(function(e){e.preventDefault();const t=zs(),n=document.getElementById("log-user-name"),r=document.getElementById("log-user-password");qs(Bs(Fs(t),"UsersList/"+n.value)).then((e=>{if(!e.exists())return alert("User not exist yet !");if(e.val().password!==r.value)return alert("The username or password was entered incorrectly !");alert(`You Successfuly enter in your accaunt  ${n.value} !`),localStorage.removeItem("watchedFilms"),localStorage.removeItem("queueFilms"),Vs.setCurrentUserFilmList(n.value),setTimeout((()=>{document.querySelector(".library__btn").classList.contains("active__btn")?Vs.renderWatchedFilms("watchedFilms","watched"):Vs.renderWatchedFilms("queueFilms","scheduled")}),100),t=e.val(),localStorage.setItem("userData",JSON.stringify(t)),document.querySelector(".close-btn").click(),so(),oo();var t}))})),ao.regForm.addEventListener("submit",(function(e){e.preventDefault();const t=document.getElementById("reg-user-name"),n=document.getElementById("reg-user-email"),r=document.getElementById("reg-user-password");if(!ro(t.value,n.value,r.value))return alert("You filled form uncorrect");const i=zs();qs(Bs(Fs(i),"UsersList/"+t.value)).then((e=>{e.exists()?alert("User already exist !"):Ms(Fs(i,"UsersList/"+t.value),{userName:t.value,email:n.value,password:r.value}).then(alert("User Successfuly registraited !")).then(document.getElementById("reg-form").reset()).catch(console.log)}))})),document.addEventListener("keydown",(e=>{"Escape"===e.code&&ao.modal.classList.add("hidden")}));var lo;lo=s("bRlFp");var co=async function(e,t){try{return(await n(lo).get(`https://api.themoviedb.org/3/movie/${t}?api_key=${e}`)).data}catch(e){console.error(e)}};function ho(e,t){if(e.target.classList.add("remove-watched-btn"),"add"===e.target.dataset.action)if(null!==localStorage.getItem("userData")){const n=JSON.parse(localStorage.getItem("userData")).userName;Vs.createWithtAuth(t,"watchedFilms",n),e.target.textContent="Remove from watched",e.target.dataset.action="remove"}else Vs.createWithoutAuth(t,"watchedFilms"),e.target.textContent="Remove from watched",e.target.dataset.action="remove";else if(null!==localStorage.getItem("userData")){const n=JSON.parse(localStorage.getItem("userData")).userName;Vs.removeWithAuth(t.id,"watchedFilms",n),Vs.renderWatchedFilms("watchedFilms","watched"),e.target.textContent="Add to queue",e.target.dataset.action="add"}else Vs.removeWithoutAuth(t.id,"watchedFilms"),Vs.renderWatchedFilms("watchedFilms","watched"),e.target.textContent="Add to watched",e.target.dataset.action="add"}function uo(e,t){if(e.target.classList.add("remove-queue-btn"),"add"===e.target.dataset.action)if(null!==localStorage.getItem("userData")){const n=JSON.parse(localStorage.getItem("userData")).userName;Vs.createWithtAuth(t,"queueFilms",n),e.target.textContent="Remove from queue",e.target.dataset.action="remove"}else Vs.createWithoutAuth(t,"queueFilms"),e.target.textContent="Remove from queue",e.target.dataset.action="remove";else if(null!==localStorage.getItem("userData")){const n=JSON.parse(localStorage.getItem("userData")).userName;Vs.removeWithAuth(t.id,"queueFilms",n),Vs.renderWatchedFilms("queueFilms","scheduled"),e.target.textContent="Add to queue",e.target.dataset.action="add"}else Vs.removeWithoutAuth(t.id,"queueFilms"),Vs.renderWatchedFilms("queueFilms","scheduled"),e.target.textContent="Add to queue",e.target.dataset.action="add"}function fo(){document.body.scrollTop=0,document.documentElement.scrollTop=0}document.addEventListener("DOMContentLoaded",(()=>{document.querySelector("[data-modal-open]"),document.querySelector("[data-modal-close]"),document.querySelector("[data-modal]"),document.querySelector(".form"),document.querySelector(".list"),document.querySelector("body");const e=(e=!1)=>{e&&(e.stopPropagation(),e.preventDefault()),document.getElementById("modal_form").closest(".modal_overlay").classList.remove("active")};document.addEventListener("click",(e=>{if(!e.target.closest(".card__film .thumb"))return!1;const n=e.target.closest(".thumb").dataset.id;co("9c3613c3b537f8ef5b027465b16a3a8b",n).then((e=>{const{genres:n,title:r,vote_average:i,vote_count:s,poster_path:o,popularity:a,original_title:l,overview:c}=e,h=`\n        <form class="form">\n        <div class="form__film-card">\n        <div class="form__film-img">\n            <img class="form-img" src="https://image.tmdb.org/t/p/w500${o}" alt="${r}"\n            onerror='this.src="https://raw.githubusercontent.com/GrooT921/team-project-filmoteka/main/src/images/no-images-found.png"'/>\n        </div>\n        </div>\n        <div class="form__info">\n        <h2 class="form__title">${r}</h2>\n        <ul class="form__info-list">\n            <li class="form__info-item">\n                <p class="form__info-name">Vote / Votes</p>\n                <p class="form__info-details"> <span class="film__rating">${i.toFixed(1)}</span> / ${s}</p>\n            </li>\n            <li class="form__info-item">\n                <p class="form__info-name">Popularity</p>\n                <p class="form__info-details">${a}</p>\n            </li>\n            <li class="form__info-item">\n                <p class="form__info-name">Original Title</p>\n                <p class="form__info-details details-title">${l}</p>\n            </li>\n            <li class="form__info-item">\n                <p class="form__info-name">Genre</p>\n                <p class="form__info-details">${u=n,u.map((e=>e.name)).join(", ")}</p>\n            </li>\n        </ul>\n        <div class="form__about">\n        <h3 class="form__about-name">About</h3>\n        <p class="form__about-details">${c}</p>\n        </div>\n        <div class="form__btn-list">\n            <button data-action=${Vs.isFilmExistInWatched(e.id)[0]} id="watched" class="form-button form-add-btn" type="button">${Vs.isFilmExistInWatched(e.id)[1]}</button>\n            <button data-action=${Vs.isFilmExistInQueue(e.id)[0]} id="queue" class="form-button form-queue-btn" type="button">${Vs.isFilmExistInQueue(e.id)[1]}</button>\n        </div>\n        </div>\n        </form>\n        `;var u;document.getElementById("modal_form").innerHTML=h,document.getElementById("watched").addEventListener("click",(t=>{ho(t,e)})),document.getElementById("queue").addEventListener("click",(t=>{uo(t,e)})),document.getElementById("modal_form").closest(".modal_overlay").classList.add("active"),t=window.scrollY,document.body.style.position="fixed",document.body.style.top=`-${t}px`}))})),document.getElementById("btn-close").addEventListener("click",(()=>{e(),n()})),document.addEventListener("click",(t=>{t.target.classList.contains("modal_overlay")&&(e(),n())})),document.getElementById("btn-close").addEventListener("click",(()=>{e()})),document.addEventListener("click",(t=>{t.target.classList.contains("modal_overlay")&&e()})),document.addEventListener("keydown",(t=>{"Escape"===t.code&&(e(),n())}));let t="";function n(){document.body.style.position="",document.body.style.top="",window.scrollTo({top:t,behavior:"instant"})}}));var po=function(){const e=document.getElementById("scroll-to-top");window.onscroll=function(){document.body.scrollTop>20||document.documentElement.scrollTop>500?e.style.display="block":e.style.display="none"},e.addEventListener("click",fo)};const go={html:document.querySelector("html"),lightTheme:document.querySelector("#light"),darkTheme:document.querySelector("#dark")};function mo(){try{"dark"===localStorage.getItem("theme")?(go.html.classList.add("dark"),go.lightTheme.classList.remove("visually-hidden"),go.darkTheme.classList.add("visually-hidden")):(go.html.classList.remove("dark"),go.lightTheme.classList.add("visually-hidden"),go.darkTheme.classList.remove("visually-hidden"))}catch(e){}}document.querySelector("#themetoggle").addEventListener("click",(e=>{e.preventDefault(),"dark"===localStorage.getItem("theme")?localStorage.removeItem("theme"):localStorage.setItem("theme","dark"),mo()})),mo();const _o={libBtnsContainer:document.querySelector(".library__btn-list")};document.querySelector("body").classList.add("scroll-hidden"),document.querySelector(".loader").classList.remove("is-hidden"),window.addEventListener("load",(()=>{_o.libBtnsContainer.addEventListener("click",Xs),null!==localStorage.getItem("userData")?(Vs.setCurrentUserFilmList(JSON.parse(localStorage.getItem("userData")).userName),document.querySelector(".library__btn").classList.contains("active__btn")?Vs.renderWatchedFilms("watchedFilms","watched"):Vs.renderWatchedFilms("queueFilms","scheduled"),so(),oo()):Vs.renderWatchedFilms("watchedFilms","watched"),document.querySelector("body").classList.remove("scroll-hidden"),document.querySelector(".loader").classList.add("is-hidden"),po()}));
//# sourceMappingURL=library.bb6a2223.js.map
